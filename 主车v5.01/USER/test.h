...
#define LED_SET  PCout(8)  //PC8 任务板LED定义
#elif SYSTEM_TASK_TYPE==TASK_TYPE0
#define LED_L PCout(15) 	//PC15 任务板左灯定义
#define LED_R PCout(14) 	//PC14 任务板右灯定义
#endif

#define BEEP  PEout(3)   // 任务板蜂鸣器定义
#define PSS   PEin(4)    // 任务板光敏状态定义

#define beep  PDout(12)  	//PD12 核心板蜂鸣器定义

#define LED_SET_APB	      RCC_APB2Periph_GPIOC //LED_SET 时钟
#define LED_SET_GPIO 	  GPIOC                //LED_SET GPIO组
#define LED_SET_PIN		  GPIO_Pin_8           //LED_SET 管脚
...
#define PSS_APB			  RCC_APB2Periph_GPIOE //PSS 时钟
#define PSS_GPIO 		  GPIOE                //PSS GPIO组
#define PSS_PIN			  GPIO_Pin_4           //PSS 管脚


#define BEEP_APB		  RCC_APB2Periph_GPIOE //BEEP 时钟
#define BEEP_GPIO 		  GPIOE                //BEEP GPIO组
#define BEEP_PIN		  GPIO_Pin_3            //BEEP 管脚
